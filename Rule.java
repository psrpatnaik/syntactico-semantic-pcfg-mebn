...
public class Rule {
	...
	ArrayList<Double> probConflation=new ArrayList<Double>();
	...
	public Rule(String left_hand, String right_hand_1, String right_hand_2, double d, double dd) {
		super();
		this.left_hand = left_hand;
		this.right_hand_1.add( right_hand_1);
		this.right_hand_2.add( right_hand_2);
		this.prob.add(d);
		this.probConflation.add(dd);
		this.tag=false;
	}

	public void updateBinaryRule(String r1, String r2, double d, double dd){
		boolean found=false;
	...
	public String toString() {
		return "Rule [left_hand=" + left_hand + ", right_hand_1="
				+ right_hand_1 + ", right_hand_2=" + right_hand_2 + ", prob="
				+ prob + ", probConflated="
						+ probConflation +", tag=" + tag + "]";
	}
